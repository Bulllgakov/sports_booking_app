...
- **SMS авторизация** с временным кодом `1234` (для тестирования)
- **Связь с бронированиями** через номер телефона
...
interface Booking {
  ...
  date: Timestamp          // 🆕 дата бронирования (стандартизовано как Timestamp)
...
```dart
// SMS авторизация с временным кодом для тестирования
class AuthService {
  static const String TEMP_CODE = '1234';
...
2. **Исправлена несогласованность данных**:
