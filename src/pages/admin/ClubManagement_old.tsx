    ...
    <PermissionGate permission={['manage_club', 'manage_all_venues']}>
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Photo Gallery - перемещено во вкладку Фотографии */}
            ...
            <button type="button" className="btn btn-secondary" onClick={() => {
              ...
              if (currentClub) {
                setFormData({
                  ...
                  financeEmail: currentClub.financeEmail || '',
                  financePhone: currentClub.financePhone || '',
                  okpo: currentClub.okpo || '',
                  okved: currentClub.okved || '',
          ...
          <div className="form-row">
            <div className="form-group">
              <label className="form-label">Email для финансовых уведомлений *</label>
              <input 
                type="email" 
                className="form-input" 
                name="financeEmail"
            ...
            <div className="form-group">
              <label className="form-label">Телефон для финансовых вопросов</label>
              <input 
                type="tel" 
                className="form-input" 
                name="financePhone"
        ...
        <div style={{ 
          ...
          <TabPanel value={activeTab} index={3}>
            <Typography variant="h6" gutterBottom>Настройки бронирования</Typography>
            <Typography variant="body2" color="text.secondary" paragraph>
              Настройте режим работы, доступные длительности и интервалы бронирования
            </Typography>
            {/* TODO: Перенести сюда настройки workingHours, bookingDurations, bookingSlotInterval */}
          </TabPanel>
        </div>
      </div>
    </PermissionGate>
